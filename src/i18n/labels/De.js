export const config = {
    ...
    villain_tiers: 'Stufen mit Girls anzeigen',
    xpMoney : 'Migliora XP / soldi',
    market: 'Marktplatz-Informationen',
    marketFilter: 'Mädchenfilter auf dem Markt',
    marketXPAff: 'XP und Zuneigung auf dem Markt',
    sortArmorItems: 'Schaltfläche zum Sortieren von Rüstungsgegenständen nach Seltenheit',
    hideSellButton: 'Schaltfläche zum Ausblenden der Schaltfläche "Verkaufen"',
