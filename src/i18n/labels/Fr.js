export const config = {
    ...
    villain_tiers: 'Montrer les paliers/filles',
    xpMoney : 'XP / Argent + précis',
    market: 'Infos marché',
    marketFilter: 'Filtre des filles au marché',
    marketXPAff: 'XP et affection au marché',
    sortArmorItems: 'Bouton pour trier les équipements par rareté',
    hideSellButton: 'Bouton pour masquer le bouton "Vendre"',
    harem: 'Infos harem',
    league: 'Infos ligue',
