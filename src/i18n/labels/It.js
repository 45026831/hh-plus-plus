export const config = {
    ...
    villain_tiers: 'Mostra battaglie con ragazze',
    xpMoney : 'Migliora XP / soldi',
    market: 'Informazioni negozio',
    marketFilter: 'Filtro per ragazze nel mercato',
    marketXPAff: 'XP e affetto nel mercato',
    sortArmorItems: 'Pulsante per ordinare l\'equipaggiamento per rarità',
    hideSellButton: 'Pulsante per nascondere il pulsante "Vendi"',
    harem: 'Informazioni Harem',
    league: 'Informazioni sulle Leghe',
    leagueBoard: 'Mostra i top della lega',
    leaguePromo: 'Mostra informazioni sulla promozione',
    simFight: 'Simulazione Leghe / Stagione / Troll',
    logSimFight : 'Accesso dettagliato nella console del browser',
    teamsFilter: 'Filtro delle squadre',
    champions: 'Informazioni sui Campioni',
    links: 'Scorciatoie/Timer',
...
export const marketGirlsFilter = {
    all: 'Tutti',
    searchedName: 'Nome ricercato',
    girlName: 'Nome della ragazza',
    searchedClass: 'Classe ricercata',
    searchedElement: 'Elemento ricercato',
    searchedRarity: 'Rarità ricercata',
    levelRange: 'Gamma di livelli',
    searchedAffCategory: 'Categoria di affetto ricercata',
    searchedAffLevel: 'Livello di affetto ricercato',
    grade0: '0 stella',
    grade1: '1 stella',
    grade2: '2 stelle',
    grade3: '3 stelle',
...
export const pachinkoNames = {
    availableGirls: 'Ragazze disponibili: '
}
