...
const buildCumulativeXPForRarity = (multiplier) => Array(HH_MAX_LEVEL - 1).fill().map((_,i) => Math.ceil(10*multiplier*(Math.pow(1.0075,i)))).reduce((a,x,i) => {a.push(x + (i===0?0:a[a.length-1]));return a}, [])
